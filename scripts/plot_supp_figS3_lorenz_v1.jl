...
optimal_coupling_regions_data_x_pos = DelimitedFiles.readdlm(DrWatson.datadir("lorenz","couplingregions_equidist__dist_1.00__cfrac_0.02__optimal_coupling__alpha_1.00_0.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_y_pos = DelimitedFiles.readdlm(DrWatson.datadir("lorenz","couplingregions_equidist__dist_1.00__cfrac_0.02__optimal_coupling__alpha_0.00_1.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_z_pos = DelimitedFiles.readdlm(DrWatson.datadir("lorenz","couplingregions_equidist__dist_1.00__cfrac_0.02__optimal_coupling__alpha_0.00_0.00_1.00.tsv"), '\t', Float64)
 
optimal_coupling_regions_data_x_neg = DelimitedFiles.readdlm(DrWatson.datadir("lorenz","couplingregions_equidist__dist_1.00__cfrac_0.02__optimal_coupling__alpha_-1.00_0.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_y_neg = DelimitedFiles.readdlm(DrWatson.datadir("lorenz","couplingregions_equidist__dist_1.00__cfrac_0.02__optimal_coupling__alpha_0.00_-1.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_z_neg = DelimitedFiles.readdlm(DrWatson.datadir("lorenz","couplingregions_equidist__dist_1.00__cfrac_0.02__optimal_coupling__alpha_0.00_0.00_-1.00.tsv"), '\t', Float64)
...
Axis3(
    ...
    azimuth = 1.60 * pi,
    elevation = 0.15 * pi,
    limits = (-32.5,32.5,-32.5,32.5,-5,60),
    xticks = [-30,-20,-10,0,10,20,30],
    xtickformat = values -> ["",L"-20","",L"0","",L"20",""],
    yticks = [-30,-20,-10,0,10,20,30],
    ytickformat = values -> ["",L"-20","",L"0","",L"20",""],
    zticks = [0,10,20,30,40,50,60],
    ztickformat = values -> [L"0","",L"20","",L"40","",L"60"],
    protrusions = (0,25,15,5),
    xticklabelpad = 1,
    yticklabelpad = 1,
    zticklabelpad = 2,
    xlabeloffset = 15,
...
attractor_plot_data = DelimitedFiles.readdlm(DrWatson.datadir("lorenz","attractor_plot.tsv"), '\t', Float64)
...
text!(axis_panel_a, 
    (0.94, 1.0), 
    text = L"\lambda \approx 0.742", #0.7420477251432132
    space = :relative, 
    align = (:right, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_b, 
    (0.94, 1.0), 
    text = L"\lambda \approx 0.460", #0.4597459120204073
    space = :relative, 
    align = (:right, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_c, 
    (0.94, 1.0), 
    text = L"\lambda \approx 0.326", #0.32624977319178805
    space = :relative, 
    align = (:right, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_d, 
    (0.94, 1.0),  
    text = L"\lambda \approx 0.759", #0.7592918647961839
    space = :relative, 
    align = (:right, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_e, 
    (0.94, 1.0), 
    text = L"\lambda \approx 0.557", #0.5569917868658684
    space = :relative, 
    align = (:right, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_f, 
    (0.94, 1.0), 
    text = L"\lambda \approx 0.689", #0.6885904921391817
    space = :relative, 
    align = (:right, :top), 
    color = :black,
    fontsize = 12
...
save(plotsdir("FIGS3_lorenz_collection_v1.pdf"), fig)
save(plotsdir("FIGS3_lorenz_collection_v1.png"), fig)
