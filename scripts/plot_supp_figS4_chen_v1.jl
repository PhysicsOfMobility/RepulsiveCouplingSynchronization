...
optimal_coupling_regions_data_x_pos = DelimitedFiles.readdlm(DrWatson.datadir("chen","couplingregions_equidist__dist_1.50__cfrac_0.01__optimal_coupling__alpha_1.00_0.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_y_pos = DelimitedFiles.readdlm(DrWatson.datadir("chen","couplingregions_equidist__dist_1.50__cfrac_0.01__optimal_coupling__alpha_0.00_1.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_z_pos = DelimitedFiles.readdlm(DrWatson.datadir("chen","couplingregions_equidist__dist_1.50__cfrac_0.01__optimal_coupling__alpha_0.00_0.00_1.00.tsv"), '\t', Float64)

optimal_coupling_regions_data_x_neg = DelimitedFiles.readdlm(DrWatson.datadir("chen","couplingregions_equidist__dist_1.50__cfrac_0.01__optimal_coupling__alpha_-1.00_0.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_y_neg = DelimitedFiles.readdlm(DrWatson.datadir("chen","couplingregions_equidist__dist_1.50__cfrac_0.01__optimal_coupling__alpha_0.00_-1.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_z_neg = DelimitedFiles.readdlm(DrWatson.datadir("chen","couplingregions_equidist__dist_1.50__cfrac_0.01__optimal_coupling__alpha_0.00_0.00_-1.00.tsv"), '\t', Float64)
...
Axis3(
    ...
    azimuth = 1.85 * pi,
    elevation = 0.15 * pi,
    limits = (-32.5,37.5,-32.5,37.5,-2,58),
    ...
    ztickformat = values -> [L"0",L"10",L"20",L"30",L"40",L"50"],
    protrusions = (0,20,15,5),
    xticklabelpad = 1,
    yticklabelpad = 1,
    zticklabelpad = 2,
    xlabeloffset = 15,
...
attractor_plot_data = DelimitedFiles.readdlm(DrWatson.datadir("chen","attractor_plot.tsv"), '\t', Float64)
...
text!(axis_panel_a, 
    (0.03, 1.0), 
    text = L"\lambda \approx 1.48", #1.4756975531913556
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_b, 
    (0.03, 1.0), 
    text = L"\lambda \approx 1.82", #1.8153268927920962
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_c, 
    (0.03, 1.0), 
    text = L"\lambda \approx 1.81", #1.8090808587371665
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_d, 
    (0.03, 1.0), 
    text = L"\lambda \approx 1.95", #1.946730717758663
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_e, 
    (0.03, 1.0), 
    text = L"\lambda \approx 1.52", #1.52234193758822
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_f, 
    (0.03, 1.0), 
    text = L"\lambda \approx 1.95", #1.9533565322434239
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
save(plotsdir("FIGS4_chen_collection_v1.pdf"), fig)
save(plotsdir("FIGS4_chen_collection_v1.png"), fig)
