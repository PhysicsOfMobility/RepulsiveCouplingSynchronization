...
optimal_coupling_regions_data_x_pos = DelimitedFiles.readdlm(DrWatson.datadir("roessler","couplingregions_equidist__dist_0.50__cfrac_0.01__optimal_coupling__alpha_1.00_0.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_y_pos = DelimitedFiles.readdlm(DrWatson.datadir("roessler","couplingregions_equidist__dist_0.50__cfrac_0.01__optimal_coupling__alpha_0.00_1.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_z_pos = DelimitedFiles.readdlm(DrWatson.datadir("roessler","couplingregions_equidist__dist_0.50__cfrac_0.01__optimal_coupling__alpha_0.00_0.00_1.00.tsv"), '\t', Float64)

optimal_coupling_regions_data_x_neg = DelimitedFiles.readdlm(DrWatson.datadir("roessler","couplingregions_equidist__dist_0.50__cfrac_0.01__optimal_coupling__alpha_-1.00_0.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_y_neg = DelimitedFiles.readdlm(DrWatson.datadir("roessler","couplingregions_equidist__dist_0.50__cfrac_0.01__optimal_coupling__alpha_0.00_-1.00_0.00.tsv"), '\t', Float64)
optimal_coupling_regions_data_z_neg = DelimitedFiles.readdlm(DrWatson.datadir("roessler","couplingregions_equidist__dist_0.50__cfrac_0.01__optimal_coupling__alpha_0.00_0.00_-1.00.tsv"), '\t', Float64)
...
panel_base = panel_title[1,1] = GridLayout()
...
text!(axis_panel_a, 
    (0.075, 1.0), 
    text = L"\lambda \approx -0.080", #-0.07970397231227003
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_b, 
    (0.075, 1.0), 
    text = L"\lambda \approx -0.120", #-0.1202260611200506
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_c, 
    (0.075, 1.0), 
    text = L"\lambda \approx 0.013", #0.013082587674689759
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_e, 
    (0.075, 1.0), 
    text = L"\lambda \approx 0.063", #0.06260782628319288
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
text!(axis_panel_f, 
    (0.075, 1.0), 
    text = L"\lambda \approx 0.020", #0.019828172257714417
    space = :relative, 
    align = (:left, :top), 
    color = :black,
    fontsize = 12
...
save(plotsdir("FIGS2_roessler_collection_v1.pdf"), fig)
save(plotsdir("FIGS2_roessler_collection_v1.png"), fig)
